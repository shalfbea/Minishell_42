...
$(MINISHELL): $(HEADER) $(SHALFBEA_HEADER) $(CBRIDGET_HEADER) $(OBJ_DIR) $(OBJ_STD) $(LIBFT)
	$(CC) $(FLAGS) $(READLINE_LIB) $(OBJ_STD) -o $(MINISHELL) $(LIBFT) $(READLINE_LIB)

$(MINISHELL_BONUS): $(HEADER) $(SHALFBEA_HEADER) $(CBRIDGET_HEADER) $(OBJ_DIR) $(OBJ_FILES_BONUS) $(LIBFT)
